...
CHANGE_GOAL = "change_goal"             # Изменить цель, под которую нужен рецепт
CLEAR_INGREDIENTS = "clear_products"    # Очистить список сохраненных ингредиентов
...
MY_INGREDIENTS = "my_ingredients"       # Получить список сохраненных ингредиентов
